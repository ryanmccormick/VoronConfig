...
G1 H1 Y360 F6000                ; +Y probe move, fast (*ADJUST* to 10mm more than your Y size)
M98 P"/macros/drive/xy_fullcurrent.g"
G91
G1 H2 Y-2 F6000                    ; back off from the endstop
G1 H1 Y3 F60                  ; +Y probe move, slow
G1 H5 Y-5 F6000                    ; back off from the endstop
